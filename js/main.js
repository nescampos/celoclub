var web3 = new Web3(new Web3.providers.HttpProvider("https://alfajores-forno.celo-testnet.org"));
...
async function checkBalance()
{
  ...
  try {
    var balance = await web3.eth.getBalance(myWallet);
    var balanceFil = web3.utils.fromWei(balance);
